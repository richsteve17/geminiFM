...
const NAMES_BY_NATION: Record<string, { first: string[], last: string[] }> = {
    'EN': {
        first: ["James", "John", "Robert", "Michael", "William", "David", "Richard", "Joseph", "Thomas", "Charles", "Liam", "Noah", "Oliver", "Elijah", "Lucas", "Mason", "Logan", "Ethan", "Jacob", "Leo", "George", "Arthur", "Freddie", "Harry", "Jack", "Oscar", "Charlie", "Jacob", "Alfie", "Isaac"],
        last: ["Smith", "Johnson", "Williams", "Brown", "Jones", "Garcia", "Miller", "Davis", "Rodriguez", "Martinez", "Taylor", "Anderson", "Thomas", "Hernandez", "Moore", "Martin", "Jackson", "Thompson", "White", "Lopez", "Scott", "Green", "Adams", "Baker", "Hall", "Rivera", "Campbell", "Mitchell", "Carter", "Roberts"]
    },
    'ES': {
...
export const generateName = (nationalityCode: string): string => {
    ...
    // Use first initial and last name as requested previously
