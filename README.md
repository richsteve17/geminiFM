...
Manage a top-tier club across a congested calendar. Dominate your domestic league on weekends and navigate the new **36-team Swiss Model Champions League** mid-week. 

### 2. World Cup Prologue
Start your journey in the Summer of '26. Lead a nation through the massive 48-team tournament. Your performance here dictates your "Manager Reputation" for club season job offers.

### 3. Unemployed (Zero to Hero)
Create your persona from a Sunday League amateur to a former legend. Face dynamic board interviews to work your way to the top.
...
*   **State Machine:** Custom match + tournament state machines handle the complex Swiss Format and multi-tier knockout brackets.
