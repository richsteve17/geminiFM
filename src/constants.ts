...
export const TEAMS: Record<string, Team> = {
    ...
    'Manchester City': { name: 'Manchester City', league: 'Premier League', players: MAN_CITY_SQUAD, tactic: { formation: '4-3-3', mentality: 'All-Out Attack' }, prestige: 95, chairmanPersonality: 'Ambitious Tycoon', balance: 550000000, objectives: ['Win the League', 'Win Champions League'], activePromises: [] },
    'Liverpool': { name: 'Liverpool', league: 'Premier League', players: LIVERPOOL_SQUAD, tactic: { formation: '4-3-3', mentality: 'All-Out Attack' }, prestige: 91, chairmanPersonality: 'Ambitious Tycoon', balance: 280000000, objectives: ['Renew V. van Dijk', 'Finish Top 2'], activePromises: [] },
    'Arsenal': { name: 'Arsenal', league: 'Premier League', players: ARSENAL_SQUAD, tactic: { formation: '4-3-3' as any, mentality: 'Attacking' }, prestige: 89, chairmanPersonality: 'Moneyball Advocate', balance: 220000000, objectives: ['Finish Top 4'], activePromises: [] },
    'Chelsea': { name: 'Chelsea', league: 'Premier League', players: CHELSEA_SQUAD, tactic: { formation: '4-2-3-1', mentality: 'All-Out Attack' }, prestige: 87, chairmanPersonality: 'Ambitious Tycoon', balance: 400000000, objectives: ['Qualify for Champions League'], activePromises: [] },
    'Tottenham': { name: 'Tottenham', league: 'Premier League', players: generatePlayers(82, 'UK'), tactic: { formation: '4-3-3', mentality: 'Attacking' }, prestige: 86, chairmanPersonality: 'Fan-Focused Owner', balance: 250000000, objectives: ['Win a Trophy'], activePromises: [] },
    ...
    'Aston Villa': { name: 'Aston Villa', league: 'Premier League', players: generatePlayers(81, 'UK'), tactic: { formation: '4-2-3-1' as any, mentality: 'Balanced' }, prestige: 84, chairmanPersonality: 'Moneyball Advocate', balance: 120000000, objectives: ['Mid-table Finish'], activePromises: [] },
    'West Ham': { name: 'West Ham', league: 'Premier League', players: generatePlayers(79, 'UK'), tactic: { formation: '4-2-3-1' as any, mentality: 'Balanced' }, prestige: 80, chairmanPersonality: 'Fan-Focused Owner', balance: 90000000, objectives: ['Avoid Relegation'], activePromises: [] },
    ...
    'Manchester United': { name: 'Manchester United', league: 'Premier League', players: generatePlayers(84, 'UK'), tactic: { formation: '4-2-3-1' as any, mentality: 'Balanced' }, prestige: 88, chairmanPersonality: 'Fan-Focused Owner', balance: 180000000, objectives: ['Finish Top 4'], activePromises: [] },
    ...
    'Wolves': { name: 'Wolves', league: 'Premier League', players: generatePlayers(77, 'UK'), tactic: { formation: '3-5-2', mentality: 'Balanced' }, prestige: 78, chairmanPersonality: 'Traditionalist', balance: 60000000, objectives: ['Mid-table Finish'], activePromises: [] },
    ...
    'Leeds United': { name: 'Leeds United', league: 'Championship', players: generatePlayers(74, 'UK'), tactic: { formation: '4-2-3-1' as any, mentality: 'Attacking' }, prestige: 75, chairmanPersonality: 'Fan-Focused Owner', balance: 40000000, objectives: ['Promotion'], activePromises: [] },
    'Norwich City': { name: 'Norwich City', league: 'Championship', players: generatePlayers(72, 'UK'), tactic: { formation: '4-2-3-1' as any, mentality: 'Balanced' }, prestige: 71, chairmanPersonality: 'Moneyball Advocate', balance: 28000000, objectives: [], activePromises: [] },
    ...
    // LA LIGA (10 Teams)
    'Real Madrid': { name: 'Real Madrid', league: 'La Liga', players: REAL_MADRID_SQUAD, tactic: { formation: '4-3-3', mentality: 'All-Out Attack' }, prestige: 98, chairmanPersonality: 'Ambitious Tycoon', balance: 600000000, objectives: ['Win Everything'], activePromises: [] },
    'FC Barcelona': { name: 'FC Barcelona', league: 'La Liga', players: BARCELONA_SQUAD, tactic: { formation: '4-3-3', mentality: 'Attacking' }, prestige: 95, chairmanPersonality: 'Fan-Focused Owner', balance: 150000000, objectives: ['Win the League'], activePromises: [] },
    'Atletico Madrid': { name: 'Atletico Madrid', league: 'La Liga', players: generatePlayers(84, 'ES'), tactic: { formation: '4-4-2', mentality: 'Defensive' }, prestige: 88, chairmanPersonality: 'Traditionalist', balance: 180000000, objectives: [], activePromises: [] },
    ...
    'Villarreal': { name: 'Villarreal', league: 'La Liga', players: generatePlayers(80, 'ES'), tactic: { formation: '4-3-3', mentality: 'Attacking' }, prestige: 81, chairmanPersonality: 'Moneyball Advocate', balance: 65000000, objectives: [], activePromises: [] },
    'Real Betis': { name: 'Real Betis', league: 'La Liga', players: generatePlayers(79, 'ES'), tactic: { formation: '4-2-3-1' as any, mentality: 'Attacking' }, prestige: 79, chairmanPersonality: 'Fan-Focused Owner', balance: 55000000, objectives: [], activePromises: [] },
    ...
    // SERIE A (10 Teams)
    'Juventus': { name: 'Juventus', league: 'Serie A', players: JUVENTUS_SQUAD, tactic: { formation: '3-5-2', mentality: 'Balanced' }, prestige: 90, chairmanPersonality: 'Traditionalist', balance: 200000000, objectives: ['Win the League'], activePromises: [] },
    'Inter Milan': { name: 'Inter Milan', league: 'Serie A', players: INTER_MILAN_SQUAD, tactic: { formation: '3-5-2', mentality: 'Balanced' }, prestige: 91, chairmanPersonality: 'Traditionalist', balance: 180000000, objectives: ['Win the League'], activePromises: [] },
    'AC Milan': { name: 'AC Milan', league: 'Serie A', players: AC_MILAN_SQUAD, tactic: { formation: '4-2-3-1', mentality: 'Attacking' }, prestige: 90, chairmanPersonality: 'Ambitious Tycoon', balance: 150000000, objectives: ['Win the League'], activePromises: [] },
    'Napoli': { name: 'Napoli', league: 'Serie A', players: generatePlayers(83, 'IT'), tactic: { formation: '4-3-3', mentality: 'Attacking' }, prestige: 88, chairmanPersonality: 'Fan-Focused Owner', balance: 150000000, objectives: [], activePromises: [] },
    'AS Roma': { name: 'AS Roma', league: 'Serie A', players: generatePlayers(81, 'IT'), tactic: { formation: '4-2-3-1' as any, mentality: 'Balanced' }, prestige: 85, chairmanPersonality: 'Ambitious Tycoon', balance: 110000000, objectives: [], activePromises: [] },
    'Lazio': { name: 'Lazio', league: 'Serie A', players: generatePlayers(80, 'IT'), tactic: { formation: '4-3-3', mentality: 'Balanced' }, prestige: 84, chairmanPersonality: 'Traditionalist', balance: 90000000, objectives: [], activePromises: [] },
    'Atalanta': { name: 'Atalanta', league: 'Serie A', players: generatePlayers(81, 'IT'), tactic: { formation: '3-4-3' as any, mentality: 'All-Out Attack' }, prestige: 83, chairmanPersonality: 'Moneyball Advocate', balance: 80000000, objectives: [], activePromises: [] },
    'Fiorentina': { name: 'Fiorentina', league: 'Serie A', players: generatePlayers(79, 'IT'), tactic: { formation: '4-3-3', mentality: 'Attacking' }, prestige: 80, chairmanPersonality: 'Fan-Focused Owner', balance: 70000000, objectives: [], activePromises: [] },
    ...
    // BUNDESLIGA (10 Teams)
    'Bayern Munich': { name: 'Bayern Munich', league: 'Bundesliga', players: BAYERN_SQUAD, tactic: { formation: '4-2-3-1', mentality: 'All-Out Attack' }, prestige: 96, chairmanPersonality: 'Ambitious Tycoon', balance: 400000000, objectives: ['Win the League', 'Win Champions League'], activePromises: [] },
    'Dortmund': { name: 'Dortmund', league: 'Bundesliga', players: generatePlayers(84, 'DE'), tactic: { formation: '4-3-3', mentality: 'Attacking' }, prestige: 89, chairmanPersonality: 'Moneyball Advocate', balance: 120000000, objectives: ['Challenge Munich'], activePromises: [] },
    'RB Leipzig': { name: 'RB Leipzig', league: 'Bundesliga', players: generatePlayers(82, 'DE'), tactic: { formation: '4-2-2-2' as any, mentality: 'Attacking' }, prestige: 86, chairmanPersonality: 'Ambitious Tycoon', balance: 150000000, objectives: [], activePromises: [] },
    'Bayer Leverkusen': { name: 'Bayer Leverkusen', league: 'Bundesliga', players: generatePlayers(83, 'DE'), tactic: { formation: '3-4-2-1' as any, mentality: 'Attacking' }, prestige: 88, chairmanPersonality: 'Moneyball Advocate', balance: 100000000, objectives: [], activePromises: [] },
    'Eintracht Frankfurt': { name: 'Eintracht Frankfurt', league: 'Bundesliga', players: generatePlayers(79, 'DE'), tactic: { formation: '4-2-3-1' as any, mentality: 'Balanced' }, prestige: 82, chairmanPersonality: 'Fan-Focused Owner', balance: 70000000, objectives: [], activePromises: [] },
    ...
    'Wolfsburg': { name: 'Wolfsburg', league: 'Bundesliga', players: generatePlayers(77, 'DE'), tactic: { formation: '4-4-2', mentality: 'Balanced' }, prestige: 78, chairmanPersonality: 'Ambitious Tycoon', balance: 80000000, objectives: [], activePromises: [] },
    ...
    'Hoffenheim': { name: 'Hoffenheim', league: 'Bundesliga', players: generatePlayers(76, 'DE'), tactic: { formation: '3-5-2', mentality: 'Attacking' }, prestige: 74, chairmanPersonality: 'Moneyball Advocate', balance: 45000000, objectives: [], activePromises: [] },

    // LIGUE 1 (10 Teams)
    'PSG': { name: 'PSG', league: 'Ligue 1', players: PSG_SQUAD, tactic: { formation: '4-3-3', mentality: 'All-Out Attack' }, prestige: 93, chairmanPersonality: 'Ambitious Tycoon', balance: 500000000, objectives: ['Win the League', 'Win Champions League'], activePromises: [] },
    'Marseille': { name: 'Marseille', league: 'Ligue 1', players: generatePlayers(80, 'FR'), tactic: { formation: '4-2-3-1' as any, mentality: 'Balanced' }, prestige: 84, chairmanPersonality: 'Fan-Focused Owner', balance: 80000000, objectives: [], activePromises: [] },
    'Lyon': { name: 'Lyon', league: 'Ligue 1', players: generatePlayers(79, 'FR'), tactic: { formation: '4-3-3', mentality: 'Balanced' }, prestige: 82, chairmanPersonality: 'Traditionalist', balance: 70000000, objectives: [], activePromises: [] },
    'Monaco': { name: 'Monaco', league: 'Ligue 1', players: generatePlayers(81, 'FR'), tactic: { formation: '4-4-2', mentality: 'Attacking' }, prestige: 85, chairmanPersonality: 'Ambitious Tycoon', balance: 120000000, objectives: [], activePromises: [] },
    'Nice': { name: 'Nice', league: 'Ligue 1', players: generatePlayers(78, 'FR'), tactic: { formation: '4-3-3', mentality: 'Balanced' }, prestige: 79, chairmanPersonality: 'Moneyball Advocate', balance: 60000000, objectives: [], activePromises: [] },
    'Lille': { name: 'Lille', league: 'Ligue 1', players: generatePlayers(79, 'FR'), tactic: { formation: '4-2-3-1' as any, mentality: 'Balanced' }, prestige: 81, chairmanPersonality: 'Moneyball Advocate', balance: 55000000, objectives: [], activePromises: [] },
    'Lens': { name: 'Lens', league: 'Ligue 1', players: generatePlayers(77, 'FR'), tactic: { formation: '3-4-3' as any, mentality: 'Attacking' }, prestige: 78, chairmanPersonality: 'Fan-Focused Owner', balance: 45000000, objectives: [], activePromises: [] },
    'Rennes': { name: 'Rennes', league: 'Ligue 1', players: generatePlayers(77, 'FR'), tactic: { formation: '4-4-2', mentality: 'Balanced' }, prestige: 77, chairmanPersonality: 'Moneyball Advocate', balance: 50000000, objectives: [], activePromises: [] },
    'Nantes': { name: 'Nantes', league: 'Ligue 1', players: generatePlayers(75, 'FR'), tactic: { formation: '4-5-1', mentality: 'Defensive' }, prestige: 74, chairmanPersonality: 'Traditionalist', balance: 30000000, objectives: [], activePromises: [] },
    ...
    'Inter Miami': { name: 'Inter Miami', league: 'MLS', players: INTER_MIAMI_SQUAD, tactic: { formation: '4-3-3', mentality: 'Attacking' }, prestige: 85, chairmanPersonality: 'Ambitious Tycoon', balance: 90000000, objectives: ['Win MLS Cup'], activePromises: [] },
    'LA Galaxy': { name: 'LA Galaxy', league: 'MLS', players: generatePlayers(74, 'US'), tactic: { formation: '4-2-3-1' as any, mentality: 'Balanced' }, prestige: 75, chairmanPersonality: 'Ambitious Tycoon', balance: 70000000, objectives: [], activePromises: [] },
    'NYCFC': { name: 'NYCFC', league: 'MLS', players: generatePlayers(74, 'US'), tactic: { formation: '4-3-3', mentality: 'Attacking' }, prestige: 76, chairmanPersonality: 'Moneyball Advocate', balance: 65000000, objectives: [], activePromises: [] },
    'Atlanta United': { name: 'Atlanta United', league: 'MLS', players: generatePlayers(75, 'US'), tactic: { formation: '4-2-3-1' as any, mentality: 'Attacking' }, prestige: 77, chairmanPersonality: 'Fan-Focused Owner', balance: 55000000, objectives: [], activePromises: [] },
    'Seattle Sounders': { name: 'Seattle Sounders', league: 'MLS', players: generatePlayers(73, 'US'), tactic: { formation: '4-3-3', mentality: 'Balanced' }, prestige: 74, chairmanPersonality: 'Traditionalist', balance: 50000000, objectives: [], activePromises: [] },
    'Portland Timbers': { name: 'Portland Timbers', league: 'MLS', players: generatePlayers(72, 'US'), tactic: { formation: '4-2-3-1' as any, mentality: 'Balanced' }, prestige: 72, chairmanPersonality: 'Fan-Focused Owner', balance: 45000000, objectives: [], activePromises: [] },
    'LAFC': { name: 'LAFC', league: 'MLS', players: generatePlayers(74, 'US'), tactic: { formation: '4-3-3', mentality: 'Attacking' }, prestige: 76, chairmanPersonality: 'Fan-Focused Owner', balance: 60000000, objectives: [], activePromises: [] },
    'Columbus Crew': { name: 'Columbus Crew', league: 'MLS', players: generatePlayers(73, 'US'), tactic: { formation: '3-4-3' as any, mentality: 'Balanced' }, prestige: 74, chairmanPersonality: 'Moneyball Advocate', balance: 50000000, objectives: [], activePromises: [] },
    'Toronto FC': { name: 'Toronto FC', league: 'MLS', players: generatePlayers(71, 'US'), tactic: { formation: '4-4-2', mentality: 'Defensive' }, prestige: 60, chairmanPersonality: 'Traditionalist', balance: 40000000, objectives: [], activePromises: [] },
    'Chicago Fire': { name: 'Chicago Fire', league: 'MLS', players: generatePlayers(70, 'US'), tactic: { formation: '4-2-3-1' as any, mentality: 'Balanced' }, prestige: 58, chairmanPersonality: 'Traditionalist', balance: 35000000, objectives: [], activePromises: [] },
    'Philadelphia Union': { name: 'Philadelphia Union', league: 'MLS', players: generatePlayers(74, 'US'), tactic: { formation: '4-4-2', mentality: 'Balanced' }, prestige: 73, chairmanPersonality: 'Moneyball Advocate', balance: 35000000, objectives: ['Develop Youth'], activePromises: [] },
    'NY Red Bulls': { name: 'NY Red Bulls', league: 'MLS', players: generatePlayers(73, 'US'), tactic: { formation: '4-2-2-2' as any, mentality: 'Balanced' }, prestige: 72, chairmanPersonality: 'Moneyball Advocate', balance: 40000000, objectives: [], activePromises: [] },
};
