...
export const TEAMS: Record<string, Team> = {
    ...
    'Newcastle United': { name: 'Newcastle United', league: 'Premier League', players: generatePlayers(82, 'UK'), tactic: { formation: '4-3-3', mentality: 'Attacking' }, prestige: 86, chairmanPersonality: 'Ambitious Tycoon', balance: 350000000, objectives: ['Qualify for Europe'], activePromises: [], colors: { primary: '#241F20', secondary: '#FFFFFF', text: '#FFFFFF' } },
    ...
    'Brighton': { name: 'Brighton', league: 'Premier League', players: generatePlayers(79, 'UK'), tactic: { formation: '4-3-3', mentality: 'Attacking' }, prestige: 81, chairmanPersonality: 'Moneyball Advocate', balance: 75000000, objectives: ['Develop Youth'], activePromises: [], colors: { primary: '#0057B8', secondary: '#FFFFFF', text: '#FFFFFF' } },
    ...
    'Everton': { name: 'Everton', league: 'Premier League', players: generatePlayers(77, 'UK'), tactic: { formation: '4-4-2', mentality: 'Defensive' }, prestige: 76, chairmanPersonality: 'Traditionalist', balance: 50000000, objectives: ['Avoid Relegation'], activePromises: [], colors: { primary: '#003399', secondary: '#FFFFFF', text: '#FFFFFF' } },
    ...
    'Fulham': { name: 'Fulham', league: 'Premier League', players: generatePlayers(77, 'UK'), tactic: { formation: '4-2-3-1' as any, mentality: 'Balanced' }, prestige: 77, chairmanPersonality: 'Moneyball Advocate', balance: 55000000, objectives: ['Avoid Relegation'], activePromises: [], colors: { primary: '#FFFFFF', secondary: '#000000', text: '#000000' } },
    'Nottingham Forest': { name: 'Nottingham Forest', league: 'Premier League', players: generatePlayers(76, 'UK'), tactic: { formation: '4-5-1', mentality: 'Defensive' }, prestige: 75, chairmanPersonality: 'Ambitious Tycoon', balance: 70000000, objectives: ['Avoid Relegation'], activePromises: [], colors: { primary: '#DD0000', secondary: '#FFFFFF', text: '#FFFFFF' } },
    'Leicester City': { name: 'Leicester City', league: 'Premier League', players: generatePlayers(76, 'UK'), tactic: { formation: '4-3-3', mentality: 'Balanced' }, prestige: 76, chairmanPersonality: 'Moneyball Advocate', balance: 65000000, objectives: ['Avoid Relegation'], activePromises: [], colors: { primary: '#0053A0', secondary: '#FDBE11', text: '#FFFFFF' } },
    'Bournemouth': { name: 'Bournemouth', league: 'Premier League', players: generatePlayers(75, 'UK'), tactic: { formation: '4-2-3-1' as any, mentality: 'Balanced' }, prestige: 74, chairmanPersonality: 'Moneyball Advocate', balance: 40000000, objectives: ['Avoid Relegation'], activePromises: [], colors: { primary: '#DA291C', secondary: '#000000', text: '#FFFFFF' } },
    'Crystal Palace': { name: 'Crystal Palace', league: 'Premier League', players: generatePlayers(77, 'UK'), tactic: { formation: '3-5-2', mentality: 'Balanced' }, prestige: 77, chairmanPersonality: 'Fan-Focused Owner', balance: 50000000, objectives: ['Mid-table Finish'], activePromises: [], colors: { primary: '#1B458F', secondary: '#C4122E', text: '#FFFFFF' } },
    'Ipswich Town': { name: 'Ipswich Town', league: 'Premier League', players: generatePlayers(73, 'UK'), tactic: { formation: '4-2-3-1' as any, mentality: 'Attacking' }, prestige: 71, chairmanPersonality: 'Moneyball Advocate', balance: 35000000, objectives: ['Avoid Relegation'], activePromises: [], colors: { primary: '#3A64A3', secondary: '#FFFFFF', text: '#FFFFFF' } },
    'Southampton': { name: 'Southampton', league: 'Premier League', players: generatePlayers(74, 'UK'), tactic: { formation: '4-3-3', mentality: 'Balanced' }, prestige: 72, chairmanPersonality: 'Moneyball Advocate', balance: 45000000, objectives: ['Avoid Relegation'], activePromises: [], colors: { primary: '#D71920', secondary: '#FFFFFF', text: '#FFFFFF' } },
    'Brentford': { name: 'Brentford', league: 'Premier League', players: generatePlayers(76, 'UK'), tactic: { formation: '4-3-3', mentality: 'Attacking' }, prestige: 75, chairmanPersonality: 'Moneyball Advocate', balance: 60000000, objectives: ['Avoid Relegation'], activePromises: [], colors: { primary: '#E30613', secondary: '#FFFFFF', text: '#FFFFFF' } },

    // CHAMPIONSHIP (10 Teams)
    'Sunderland': { name: 'Sunderland', league: 'Championship', players: generatePlayers(74, 'UK'), tactic: { formation: '4-4-2', mentality: 'Balanced' }, prestige: 75, chairmanPersonality: 'Fan-Focused Owner', balance: 45000000, objectives: [], activePromises: [], colors: { primary: '#FF0000', secondary: '#FFFFFF', text: '#FFFFFF' } },
    ...
    'Valencia': { name: 'Valencia', league: 'La Liga', players: generatePlayers(79, 'ES'), tactic: { formation: '4-4-2', mentality: 'Balanced' }, prestige: 80, chairmanPersonality: 'Ambitious Tycoon', balance: 60000000, objectives: [], activePromises: [], colors: { primary: '#FFFFFF', secondary: '#000000', text: '#000000' } },
