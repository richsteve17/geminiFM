...
export const TEAMS: Record<string, Team> = {
    ...
    'Arsenal': { name: 'Arsenal', league: 'Premier League', players: generatePlayers(83, 'UK'), tactic: { formation: '4-3-3' as any, mentality: 'Attacking' }, prestige: 89, chairmanPersonality: 'Moneyball Advocate', balance: 220000000, objectives: ['Finish Top 4'], activePromises: [], colors: { primary: '#EF0107', secondary: '#063672', text: '#FFFFFF', third: '#00B2A9' } },
    ...
    // LA LIGA (10 Teams)
    'Real Madrid': { name: 'Real Madrid', league: 'La Liga', players: generatePlayers(88, 'ES'), tactic: { formation: '4-3-3', mentality: 'All-Out Attack' }, prestige: 98, chairmanPersonality: 'Ambitious Tycoon', balance: 600000000, objectives: ['Win Everything'], activePromises: [], colors: { primary: '#FFFFFF', secondary: '#FEBE10', text: '#000000', third: '#808080' } },
    'FC Barcelona': { name: 'FC Barcelona', league: 'La Liga', players: generatePlayers(86, 'ES'), tactic: { formation: '4-3-3', mentality: 'Attacking' }, prestige: 95, chairmanPersonality: 'Fan-Focused Owner', balance: 150000000, objectives: ['Win the League'], activePromises: [], colors: { primary: '#A50044', secondary: '#004D98', text: '#FFFFFF', third: '#CCFF00' } },
