            ...
            <div className="w-full bg-gray-900/60 border border-gray-800 rounded-xl p-6 shadow-2xl">
                <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-2">
                        ...
                        <h4 className="text-sm font-bold text-gray-200 uppercase tracking-widest">Build Status: Alpha v0.8</h4>
                    </div>
                    <button 
                    ...
                    <div className="space-y-4 animate-in fade-in duration-500">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-3">
                                <h5 className="text-xs font-black text-gray-500 uppercase tracking-widest border-b border-gray-800 pb-1">Technical Audacity</h5>
                                <p className="text-sm text-gray-400 leading-relaxed">
                                    We run a <span className="text-gray-200 font-semibold">deterministic math engine</span> for background league simulation (no tokens wasted) and <span className="text-gray-200 font-semibold">Gemini LLM reasoning</span> exclusively for user-facing matches, interviews, and press.
                                </p>
                                <p className="text-sm text-gray-400 leading-relaxed">
                                    Every match result passes through our <span className="text-green-500 font-mono italic">"Hawk-Eye" Validator</span> to ensure the AI doesn't hallucinate illegal states (like scoring with a sent-off player).
                                </p>
                            </div>
                            <div className="space-y-3">
                                ...
                                <ul className="text-sm text-gray-400 space-y-2">
                                    ...
                                    <li className="flex items-start gap-2">
                                        <span className="text-green-500">✓</span> <span>Natural Language Scouting (Try it!)</span>
                                    </li>
                                    <li className="flex items-start gap-2">
